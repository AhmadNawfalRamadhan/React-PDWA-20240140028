...
function DataStream() {
  const lines=["SYSTEM_BOOT:OK","PHASE_SHIFT:ENGAGED","RISING_FREEDOM:STANDBY","DRAGOON:ARMED","COORDINATOR_AI:ACTIVE","LACUS_RELAY:OK","KIRA_UNIT:ONLINE","ATHRUN:READY","SHINN:STANDBY","COMMS:ENCRYPTED","FUEL:87%","ORBITAL_POS:L1-STABLE","BEAM_SABER:CHARGED","TARGETING:LOCK","SHIELD:100%"];
  return (
